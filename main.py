...
class Features():
    ...
    async def CREATOR(self, Account_Number: int, Phone_Number: str, Name: str, Username: str, Password: str, Proxy: str, use_proxy: bool = False):
        ...
        try:
            ...
            p.info(f"Successfully got ip address")
        except Exception as e:
            p.warning(f"Unable to get ip address")
...
if __name__ == "__main__":
    ...
    p.info("WieszakWare InstaGen By [ Wieszak#0384 [ https://wieszakware.epizy.com ] ] x [ Bombelek#2206 ]") # TODO: Dopisano autorów
